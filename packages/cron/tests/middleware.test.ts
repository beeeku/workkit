...
import { withTimeout, withRetry, withErrorReporting } from '../src/middleware'
...
describe('withErrorReporting()', () => {
  ...
  it('reports errors and rethrows', async () => {
    ...
    await expect(
      wrapped(event, env, createMockCtx()),
