 ...
 */
export function detectInstalledPackages(packageJson: {
 ...
 */
export function buildCatalog(installed: Map<string, string>): PackageInfo[] {
 ...
 */
export async function executeCatalog(dir: string, fs: FileSystem): Promise<PackageInfo[]> {
