...
import { loadAttachments } from "../src/attachments";
import { AttachmentTooLargeError } from "../src/errors";
...
describe("loadAttachments()", () => {
	it("returns blobs in input order", async () => {
	...
	it("throws AttachmentTooLargeError when the cap is exceeded", async () => {
