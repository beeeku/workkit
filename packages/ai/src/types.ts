...
export type ImageClassificationModel =
...
export type SummarizationModel =
...
export type InferInput<M extends string> =
  M extends TextGenerationModel ? TextGenerationInput :
  M extends TextEmbeddingModel ? TextEmbeddingInput :
  M extends ImageClassificationModel ? ImageClassificationInput :
  M extends SpeechToTextModel ? SpeechToTextInput :
  M extends TextToImageModel ? TextToImageInput :
  M extends TranslationModel ? TranslationInput :
  M extends SummarizationModel ? SummarizationInput :
  Record<string, unknown>

/** Infer the output type for a given model string */
export type InferOutput<M extends string> =
  M extends TextGenerationModel ? TextGenerationOutput :
  M extends TextEmbeddingModel ? TextEmbeddingOutput :
  M extends ImageClassificationModel ? ImageClassificationOutput :
  M extends SpeechToTextModel ? SpeechToTextOutput :
  M extends TextToImageModel ? TextToImageOutput :
  M extends TranslationModel ? TranslationOutput :
  M extends SummarizationModel ? SummarizationOutput :
  unknown
