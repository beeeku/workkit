import { TimeoutError, UnauthorizedError, ValidationError } from "@workkit/errors";
// tests/errors.test.ts
import { describe, expect, it } from "vitest";
import { MCPProtocolError, toJsonRpcError, toMCPToolError, toRestError } from "../src/errors";
