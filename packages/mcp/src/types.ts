...
export interface ToolHandlerContext<TInput extends StandardSchemaV1, TEnv> {
...
) => MaybePromise<TOutput extends StandardSchemaV1 ? InferOutput<TOutput> : unknown>;
...
export interface PromptHandlerContext<TArgs extends StandardSchemaV1 | undefined, TEnv> {
...
export type PromptHandler<TArgs extends StandardSchemaV1 | undefined, TEnv> = (
