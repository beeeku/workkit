...
import { ForbiddenError, UnauthorizedError } from "./categories/auth";
import { NotFoundError } from "./categories/data";
import { InternalError } from "./categories/internal";
import { RateLimitError, ServiceUnavailableError, TimeoutError } from "./categories/network";
 ...
 */
export function isErrorCode<C extends WorkkitErrorCode>(error: unknown, code: C): boolean {
