import type { ApprovalRequestData, ApprovalState, DecisionResult } from "./types";
...
export function createApprovalRequestLogic(storage: StorageLike) {
  ...
  return {
    async create(input: Omit<ApprovalRequestData, "decisions" | "consumedTokens" | "currentEscalationLevel" | "createdAt">): Promise<void> {
...
export class ApprovalRequestDO implements DurableObject {
  ...
  constructor(private state: DurableObjectState) {
    this.logic = createApprovalRequestLogic(state.storage);
  }
