...
// ─── Workflow Status ──────────────────────────────────────────
export type WorkflowStatus = "pending" | "running" | "completed" | "failed" | "cancelled" | "waiting" | "sleeping";
...
export interface WorkflowDef<TInput, TOutput extends Record<string, unknown> = Record<string, unknown>> {
